...
//     // Message msg = handler.obtainMessage(bluetooth.MESSAGE_TOAST);
...
//     // Message msg = handler.obtainMessage(bluetooth.MESSAGE_DEVICE_OBJECT);
//     // Bundle bundle = new Bundle();
//     // bundle.putParcelable(bluetooth.DEVICE_OBJECT, device);
//     // msg.setData(bundle);
//     // handler.sendMessage(msg);
...
//           // toDo: enable
//           // handler.obtainMessage(cordova.getActivity().MESSAGE_READ, bytes, -1,
//           // buffer).sendToTarget();
//         } catch (IOException e) {
//           connectionLost();
//           // Start the service over to restart listening mode
...
//         // toDo: enable
//         // handler.obtainMessage(cordova.getActivity().MESSAGE_WRITE, -1, -1,
//         // buffer).sendToTarget();
//       } catch (IOException e) {
//       }
//     }
